		...
		<el-tab-pane label="菜单列表">
			...
			<el-col :span="24" class="toolbar">
				<el-form :inline="true" :model="formInline" class="demo-form-inline">
					<el-form-item>
						<el-input v-model="formInline.user" placeholder="菜单"></el-input>
					</el-form-item>
					<el-form-item>
			...
			<template>
				<el-table :data="tableData" highlight-current-row v-loading="listLoading" style="width: 100%;">
					...
					<el-table-column prop="href" label="链接" width="180" sortable></el-table-column>
					<el-table-column prop="sort" label="排序" width="180" sortable></el-table-column>
					<el-table-column prop="is_show" label="可见" width="180" sortable></el-table-column>
					<el-table-column prop="permission" label="权限标识" width="180" sortable></el-table-column>		
					<el-table-column inline-template :context="_self" label="操作">
				<span>              
					<el-button type="text" size="small" @click="handleEdit(row)">编辑</el-button>
					<el-button type="text" size="small" @click="handleDel(row)">删除</el-button>
					<el-button type="text" size="small" @click="handleDel(row)">添加下级菜单</el-button>
				</span>
					</el-table-column>
				</el-table>
			</template>
		...
		<el-tab-pane label="菜单添加">
			<el-form :model="editForm" label-width="120px" :rules="editFormRules" ref="editForm" style="margin:10px;width:50%;min-width:200px;">
				...
				<el-form-item label="链接">
					<el-input v-model="editForm.href" auto-complete="off"></el-input>
				</el-form-item>
...
<script>
	...
	import tmp_data from '../../data/menu.json'
  ...
  export default {
    ...
    data() {
      return {
				...
				//编辑界面数据
				editForm:   {
					"id": "df7ce823c5b24ff9bada43d992f373e2",
					"parent_id": "ba8092291b40482db8fe7fc006ea3d76",
					"parent_ids": "0,1,79,3c92c17886944d0687e73e286cada573,ba8092291b40482db8fe7fc006ea3d76,",
					"name": "查看",
					"sort": 30,
					"href": "",
					"target": "",
					"icon": "",
					"is_show": 0,
					"permission": "test:testData:view",
					"create_by": 1,
					"create_date": "2013-08-12 13:10:05.000",
					"update_by": 1,
					"update_date": "2013-08-12 13:10:05.000",
					"remarks": "",
        		},
				editLoading:false,
				btnEditText:'提 交',
